...
type (
	User interface {
		...
		VkLogin(ctx context.Context, vkLaunchParams string) (*entity.User, string, error)
		VkLoginByAccessToken(ctx context.Context, userAccessToken string) (*entity.User, string, error)
	}
	UserRepo interface {
